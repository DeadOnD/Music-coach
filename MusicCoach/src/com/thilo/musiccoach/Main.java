...
public class Main extends Activity implements ModuleListFragment.OnModuleSelectedListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_manage) {
            ...
            Spanned s = Html.fromHtml("<p>Music Coach is a modified version of Earmouse under Apache 2 license  " + " by Paul Klinkenberg\n" +
                    "</p>\n" +
                    "If you have any questions, suggestions or feedback, please contact him by <a href=\"mailto:pklinken.development@gmail.com\"" +
                    ">mail</a> or visit " +
     ...
     * Depending on the layout, either starts an {@link com.thilo.musiccoach.ExerciseActivity} Intent
     * with the position of the clicked item or updates the {@link com.thilo.musiccoach.ExerciseFragment }
     ...
     * Invalidates the current adapter used for the ListView in {@link com.thilo.musiccoach.Main}.
     */
     ...
     * Will purge the selected modules, ask {@link com.thilo.musiccoach.ExerciseFragment} to display the
     ...
     * Resets the history of the selected modules and updates {@link com.thilo.musiccoach.ModuleListFragment}
     * and {@link com.thilo.musiccoach.ExerciseFragment} and displays a Toast indicating the successful history reset.
     * @param dialog The dialog that was clicked will be passed into the method.
     */
    @Override

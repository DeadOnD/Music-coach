...
public class Module implements Comparable<Module>{
	...
	/**
	 * Generates an Exercise that can be used by {@link com.thilo.musiccoach.MediaFragment} to generate
     * a WAV sample.
	 * <p> 
     ...
     * The result can be used by {@link com.thilo.musiccoach.MediaFragment} to generate a WAV sample.

...
public class ModuleManagerActivity extends Activity implements ManagerListFragment.OnModuleSelectedListener {
    ...
    /**
     * Shows the selected Module in detail, either by updating {@link com.thilo.musiccoach.ManagerDetailsFragment} if available or otherwise
     * starting an Intent for {@link com.thilo.musiccoach.ManagerDetailActivity}
    ...
    /**
     * Defer onClick() event to {@link com.thilo.musiccoach.ManagerDetailsFragment} (tablet only)
     ...
     * in {@link com.thilo.musiccoach.ManagerListFragment}
     * @author Paul Klinkenberg <pklinken.development@gmail.com>
     */
